(function () {
  ...
  var QUICK_WISHES = [
    { target: '妈妈', title: '带妈妈看一次海', category: '陪伴',
      ...
      plan: '国庆假期，订去海边的票。选她能走得动的路线。带上她爱吃的点心。' },
    ...
    { target: '外公', title: '问他当年参军的故事', category: '传承',
      why: '只知道他当过兵，不知道他在部队里发生过什么。',
      plan: '回老家住一晚，让他讲。录下来。他说的每一句都是历史。' },
    { target: '外婆', title: '陪她回一次老家', category: '陪伴',
      why: '她说那里有棵老槐树，她小时候在上面摘过槐花。',
      plan: '清明假期，陪她回。带身份证，带晕车药。' },
    { target: '爷爷', title: '学会他那套太极拳', category: '传承',
      why: '他打了四十年，我连起势都不会。现在学还来得及。',
      plan: '每周六早上跟他学。录下他打的每一式，慢放。' },
    { target: '弟弟', title: '跟他好好说一次"对不起"', category: '和解',
      why: '当年那件事，不是他的错。我一直没说出口。',
      plan: '找个安静的地方，当面说。不需要解释，就说对不起。' },
    { target: '儿子', title: '陪他做一件他喜欢的事', category: '陪伴',
      why: '总是说"等忙完"，可他等不及长大。',
      plan: '本周六，放下手机，全程不看手机，就陪他。' },
    { target: '自己', title: '给十年前的自己写回信', category: '仪式',
      why: '十年前的我写了一封信给现在。现在是时候回信了。',
      plan: '今晚就写。告诉他：当年的担心是多余的。' }
  ];
